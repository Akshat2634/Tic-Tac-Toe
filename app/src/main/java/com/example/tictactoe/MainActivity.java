...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private boolean player1Turn = true;  //player with x will start first //
    private int roundCount; //total round count will be 9//
    ...
    @Override
    public void onClick(View v) {
        if (!((Button) v).getText().toString().equals("")) { //checks if the button clicked has an empty string and if this is not the case this means that button has been already used. //
            return;
        }
        if (player1Turn) {
            ((Button) v).setText("X");
